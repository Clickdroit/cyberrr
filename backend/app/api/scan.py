...
from app.schemas import ScanListItem, ScanRequest, ScanResponse, ToolStatusSchema
...
async def create_scan(
    ...
    tools_for_type = {
        "username": ["maigret", "sherlock", "scraper"],
        "email": ["holehe", "ghunt", "scraper"],
        "phone": ["phone_lookup"],
        "unknown": ["maigret", "sherlock", "scraper"],
    }
